  ...
  return (
    <section id="experience" className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto bg-surface">
      <header className="mb-20 max-w-3xl">
        ...
        >
          Your Twin doesn’t just answer. <span className="text-primary">It acts ahead.</span>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          Banza turns your connected apps and personal signals into proactive experiences — helping you decide what to eat, what to watch, what to buy, and where to go, before you even ask.
        </motion.p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
        ...
        >
          ...
          <div className="absolute bottom-0 right-0 w-3/4 h-3/4 opacity-20 pointer-events-none translate-x-1/4 translate-y-1/4 group-hover:opacity-50 group-hover:scale-110 transition-all duration-700">
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuACKBitf0oULApWAJ4YQ5ziokRaCcpYGhWD02d7w2d0xV_1LDv09m3FPtr4AZwUgT2tlnu46vFrGEPt_JbDbxfUrjNgPS7TcCHhr3OW8jzkHtuwPScE-_0mORKwED2qP_7Xacb-SGmRURzlLO6inkA-5XvKr0REwBiDXrgB9lJaGVMFWb2R1Qf-FzfrI5wUrGWVjW73XKogDrN5AlDIwZLjzRE7W_3U1CMqlalf6Zl-ynijgBJId-ygDzqsKu1eePqiC1gBpuwM1kc"
              alt="Food"
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-6 relative z-10">
            ...
            <span className="font-headline font-bold text-lg group-hover:text-primary transition-colors duration-300">Entertainment that actually lands</span>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col justify-end pb-4">
                ...
                >
                  ...
                  <p className="text-xs text-on-surface font-medium italic font-body">"Matches your collection of brutalist pottery."</p>
                </motion.div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="absolute top-8 left-8 z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="font-headline font-bold text-lg group-hover:text-primary transition-colors duration-300">Travel ideas you’d actually take</span>
            </div>
          </div>
          <div className="text-center px-4 space-y-6 mt-12 relative z-10">
            <div className="relative inline-block">
              <motion.img
                ...
                alt="Travel"
                className="w-64 h-64 rounded-full object-cover mx-auto ring-8 ring-surface-container-low group-hover:ring-primary/30 transition-shadow duration-700"
                referrerPolicy="no-referrer"
              />
              <motion.div
                variants={{
